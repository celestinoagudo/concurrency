...
public class ThreadPinning {
    private static final Logger log = LoggerFactory.getLogger(ThreadPinning.class);
    ...
    private static synchronized void updateSharedDocument() throws InterruptedException {
