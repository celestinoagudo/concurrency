...
public class ScopedValueDemo {
    ...
    public static void main(String[] args) {
        ...
        Thread.ofVirtual().name("request-1").start(() -> authFilter(ScopedValueDemo::orderController));
        Thread.ofVirtual().name("request-2").start(() -> authFilter(ScopedValueDemo::orderController));
