package com.grind.two.four.seven.virthualthreads.config;
...
public class ServiceClientsConfig {
    ...
    @Bean
    public LocalRecommendationsServiceClient recommendationServiceClient(@Value("${local-recommendation.service.url}") String baseUrl) {
        return new LocalRecommendationsServiceClient(buildRestClient(baseUrl));
    }
